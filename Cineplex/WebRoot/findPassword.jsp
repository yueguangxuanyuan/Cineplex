...
<body>
	...
	<div class="container" style="padding-top:10%">
		<div class="col-xs-12 col-md-offset-3 col-md-6" style="background:url(./pic/window_bg.jpg);border-radius:15px; padding:3%;">
			<div style="text-align:center;font-size:20px">找回密码</div>
			<form class="form-horizontal register-form" style="padding-top:3%">
				...
				<div class="form-group">
					<label for="userid" class="col-md-3 control-label" >帐号</label>
					<div class="col-md-8">
				...
				<div class="form-group">
				    ...
				    <div><a href="Login.jsp" class="btn btn-default">返回登录</a></div>	
				</div>
