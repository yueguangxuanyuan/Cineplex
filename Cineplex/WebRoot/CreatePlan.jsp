		...
		<div id="onShelfFilmDiv">
			<div class="row">
				...
				<table class="table table-striped">
					...
					<tr onclick="getCertainActionforDiv('GetDoFilmPlanPage.action','doFilmPlanDiv', '<%=sendInfo%>')">
				...
				<ul class="pagination">
					<li><a
						onclick="getCertainPageforDiv('GetTargetOnShelfFilm.action','onShelfFilmDiv', <%=formerPage%>)">&laquo;</a>
					</li>
					<%
					...
					%>
					<li class="active"><a
						onclick="getCertainPageforDiv('GetTargetOnShelfFilm.action','onShelfFilmDiv', <%=i%>)"><%=i%></a>
					</li>
					<%
						} else {
					%>
					...
					%>
					<li><a
						onclick="getCertainPageforDiv('GetTargetOnShelfFilm.action','onShelfFilmDiv', <%=latterPage%>)">&raquo;</a>
					</li>
				</ul>
				<%
					}
