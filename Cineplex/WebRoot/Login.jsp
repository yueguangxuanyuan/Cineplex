...
<body>
	...
	<div class="login-frame col-md-6 col-md-offset-3"
		...
		<div class="row" style="padding-top:5%">
			...
			<div class="col-md-10 col-md-offset-1 row login-panel">
				...
				%>
				<form role="form" class="center" method="post"
					action="Login_login.do">
					<!-- <div class="row selector">
					<ul class=" list-inline">
					<li class="col-md-3 ite">会员</li>
					<li class="col-md-3">售票员</li>
					<li class="col-md-3">经理</li>
				</ul>
			</div> -->
					<div class="row">
						<label class="col-md-offset-1 col-md-10">
						<h3 class="color-white">用户登录</h3>
					</div>
					<div class="row">
